...
class EntryObjTest extends TestCase
{
     ...
     */
    public function parses_env_lines(string $line, string $key, $value, bool $isSeparator): void
    {
     ...
     * @dataProvider getDummyData
     */
    public function returns_env_lines(string $line, string $key, $value, bool $isSeparator): void
    {
        $entry = EntryObj::parseEnvLine($line, 2, 8);
     ...
     * @dataProvider getDummyData
     */
    public function returns_value_or_default(string $line, string $key, $value, bool $isSeparator): void
    {
        $entry = EntryObj::parseEnvLine($line, 2, 8);
